<?php
    ...
    //if (isset($_GET['vittoria'], $_GET['giocatore1_id'], $_GET['giocatore2_id'], $_GET['vantaggioPezzi1'], $_GET['vantaggioPezzi2'])) {
    ...
    if (isset($_GET['vittoria'], $_GET['giocatore1_id'], $_GET['giocatore2_id'])) {
        ...
        //$vantaggioPz1 = $_GET['vantaggioPezzi1'];
        //$vantaggioPz2 = $_GET['vantaggioPezzi2'];
        ...
        if ($vittoria == 1) {
            ...
            $query = "UPDATE giocatore SET parPatte =  parPatte + 1, punti = punti + $puntiPareggio /*vantPezzi = vantPezzi + $vantaggioPz1, vantPezzi = vantPezzi + $vantaggioPz2*/ WHERE idGiocatore IN ($giocatore1_id, $giocatore2_id)";
            mysqli_query($conn, $query);
            header("location: partite.php");
        } elseif($vittoria == 2) {
