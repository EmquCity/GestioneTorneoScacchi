            ...
            for ($girone = 1; $girone <= $num_gironi; $girone++) {
                ...
                for ($i = 0; $i < $num_giocatori - 1; $i++) {
                    for ($j = $i + 1; $j < $num_giocatori; $j++) {
                        ...
                        echo "<input type='checkbox' id='vantaggio1' name='vittoria' value='1' class='btn-check'>";
                        echo "<label class='btn btn-outline-primary' for='vantaggio1'>1</label>";
                        echo "<input type='checkbox' id='vantaggioX' name='vittoria' value='X' class='btn-check'>";
                        echo "<label class='btn btn-outline-primary' for='vantaggioX'>X</label>";
                        echo "<input type='checkbox' id='vantaggio2' name='vittoria' value='2' class='btn-check'>";
                        echo "<label class='btn btn-outline-primary' for='vantaggio2'>2</label>";
                        echo "</div>";
