            ...
            for ($girone = 1; $girone <= $num_gironi; $girone++) {
                ...
                for ($i = 0; $i < $num_giocatori - 1; $i++) {
                    for ($j = $i + 1; $j < $num_giocatori; $j++) {
                        ...
                        echo "<input type='number' name='vantaggioPz1' class='form-control' placeholder='Vantaggio Pezzi Giocatore 1'>";
                        echo "<input type='number' name='vantaggioPz2' class='form-control'  style='`margin-right: 10px' placeholder='Vantaggio Pezzi Giocatore 2'>";
                        echo "<div class='btn-group' role='group' aria-label='Checkbox vantaggio'>";
                        echo "<label class='btn btn-outline-secondary'>";
                        echo "<input type='checkbox' name='vittoria' value='1'> 1";
                        echo "</label>";
                        echo "<label class='btn btn-outline-secondary'>";
                        echo "<input type='checkbox' name='vittoria' value='X'> X";
                        echo "</label>";
                        echo "<label class='btn btn-outline-secondary'>";
                        echo "<input type='checkbox' name='vittoria' value='2'> 2";
                        echo "</label>";
                        echo "</div>";
